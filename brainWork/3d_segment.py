...
l_conv_1 = lasagne.layers.dnn.Conv3DDNNLayer(input,50, (3,3,3))

#l_maxpool_1 = lasagne.layers.dnn.MaxPool3DDNNLayer(l_conv_1, (2,2,2))

l_conv_2 = lasagne.layers.dnn.Conv3DDNNLayer(l_conv_1, 50, (3,3,3))
...
l_conv_11 = lasagne.layers.dnn.Conv3DDNNLayer(input, 20, (3,3,3))
...
for epoch in range(num_epochs):
   ...
   # Train = np.random.choice(Train_all, 5)
    ...
    for img in Test:
        X_test, XX, Y_test  = DP.Patch_3D_para(img,testLeft,testRight,PS, PS2)
...
np.savez('/home/xvt131/Biomediq/Functions/Adhish_copy/Exp101/3Dadam.npz', *lasagne.layers.get_all_param_values(output))

np.savez('/home/xvt131/Biomediq/Functions/Adhish_copy/Exp101/3Dadam_loss', loss, train_acc, valid_loss, valid_acc)
