...
input3 = lasagne.layers.InputLayer((None, 1, 15,15,15), input_var=input3_var)

l_conv_11 = lasagne.layers.dnn.Conv3DDNNLayer(input3, 50, (5,5,5))

l_maxpool_1 = lasagne.layers.dnn.MaxPool3DDNNLayer(l_conv_11, (3,3,3))
...
Train4 = DP.get_paths("/home/xvt131/Running/train4")

Test = DP.get_paths("/home/xvt131/Running/validating")
...
for epoch in range(num_epochs):
    ...
    for im in Train:
        #print counter
        Big, Lab, Ind = Patch_3D_para(im, 15)
    ...
    for img in Train:
        [X_test, X_Bigs], X_post, Y_test  = DP.voxel_samples2(im, [9, 5])
