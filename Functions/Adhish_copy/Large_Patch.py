...
for epoch in range(num_epochs):
   ...
   # Train = np.random.choice(Train_all, 5)
    ...
    if (epoch) % 10 == 0:
        ...
        np.savez('/home/xvt131/Functions/Adhish_copy/three_param/epoch_%d_params2.npz' %(epoch), *lasagne.layers.get_all_param_values(output))
...
np.savez('three_Params2.npz', *lasagne.layers.get_all_param_values(output))

np.savez('Loss_values2_3D.npz', loss, train_acc, valid_loss, valid_acc)
