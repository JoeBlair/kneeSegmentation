...
for epoch in range(num_epochs):
  ...
  #          print preds
    ...
    if (epoch) % 10 == 0:
        ...
        np.savez('/home/xvt131/Functions/Adhish_copy/plan_param/epoch_%d_Pparams.npz' %(epoch), *lasagne.layers.get_all_param_values(output))    
...
np.savez('planar_Params_class.npz', *lasagne.layers.get_all_param_values(output))
np.savez('Loss_values_planar.npz', loss, train_acc,  valid_loss,valid_acc )
