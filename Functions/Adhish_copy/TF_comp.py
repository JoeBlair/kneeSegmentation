...
#Output Layer
output = lasagne.layers.DenseLayer(Merged, num_units=NC, nonlinearity = lasagne.nonlinearities.softmax)
...
for epoch in range(num_epochs):
    cur_loss = 0
    val_loss = 0
    confusion_valid = ConfusionMatrix(NC)
    confusion_train = ConfusionMatrix(NC)
...
np.savez('/home/xvt131/Functions/Adhish_copy/compz/2comp_params.npz', *lasagne.layers.get_all_param_values(output))
np.savez('/home/xvt131/Functions/Adhish_copy/Loss_values_2comp.npz', loss, train_acc, valid_loss, valid_acc )
