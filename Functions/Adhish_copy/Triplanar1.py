...
l_conv_1 = lasagne.layers.dnn.Conv2DDNNLayer(l_conv_1, 20, (5,5))
...
l_conv_11 = lasagne.layers.dnn.Conv2DDNNLayer(l_conv_11, 20, (5,5))
...
l_conv_111 = lasagne.layers.dnn.Conv2DDNNLayer(l_conv_111, 20, (5,5))


l_hidden3 = lasagne.layers.DenseLayer(l_conv_111, num_units=256,nonlinearity=lasagne.nonlinearities.rectify,W=lasagne.init.HeNormal(gain='relu'))
...
#Output Layer
output = lasagne.layers.DenseLayer(Dropout, num_units=2, nonlinearity = lasagne.nonlinearities.sigmoid)
...
updates = lasagne.updates.adam(all_grads, all_params,learning_rate=0.01, beta1=0.9, beta2=0.999, epsilon=1e-08)
...
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/smalldeep.npz', *lasagne.layers.get_all_param_values(output))
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/smalldeeploss.npz', loss, train_acc, valid_loss, valid_acc )
