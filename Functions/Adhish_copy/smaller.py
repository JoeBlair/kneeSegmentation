...
l_conv_2 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_1, 40,(3,3))
...
l_conv_22 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_11, 40, (3,3))
...
l_conv_222 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_111, 40,(3,3))
...
updates = lasagne.updates.nesterov_momentum(all_grads, all_params, learning_rate=0.000001, momentum=0.8)
...
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/cheat_small.npz', *lasagne.layers.get_all_param_values(output))
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/cheats_loss.npz', loss, train_acc, valid_loss, valid_acc )
