...
with np.load("/home/xvt131/Functions/Adhish_copy/triplanar_Params_BTF.npz") as f:
...
for img in DP.get_paths("/home/xvt131/Functions/Adhish_copy/Validating-Rand"):
    ...
    print TibiaD
    io.savemat("/home/xvt131/Functions/Adhish_copy/trideeper/Seg_%s" %(img[-36:-30]), mdict= {"Seg_%s" %(img[-36:-30]):Final_pred,"Lab_%s" %(img[-36:-30]):Lab} )
