...
updates = lasagne.updates.nesterov_momentum(all_grads, all_params, learning_rate=0.1, momentum=0.5)
...
np.savez('/home/xvt131/Functions/Adhish_copy/TP_param/Loss_values_Tri_reg.npz', loss, train_acc, valid_loss, valid_acc )
