...
l_maxpool_2 = lasagne.layers.dnn.Pool2DDNNLayer(l_conv_2, (2,2))

l_conv_3 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_2, 80, (3,3))
...
l_maxpool_22 = lasagne.layers.dnn.Pool2DDNNLayer(l_conv_22, (2,2))

l_conv_33 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_22, 80, (3,3))
...
l_maxpool_222 = lasagne.layers.dnn.Pool2DDNNLayer(l_conv_222, (2,2))

l_conv_333 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_222, 20, (3,3))
#l_maxpool_2 = lasagne.layers.dnn.MaxPool3DDNNLayer(l_conv_2, (1,1,1))
...
for epoch in range(num_epochs):
    ...
    if (epoch) % 10 == 0:
        ...
        np.savez('/home/xvt131/Functions/Adhish_copy/triplan2_param/epoch_%d_paramsBTF.npz' %(epoch), *lasagne.layers.get_all_param_values(output))    
...
np.savez('triplanar_Params_BTF.npz', *lasagne.layers.get_all_param_values(output))
np.savez('Loss_values_BTF.npz', loss, train_acc,  valid_loss,valid_acc )
