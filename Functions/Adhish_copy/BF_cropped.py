...
np.savez('/home/xvt131/Functions/Adhish_copy/TP_param/triplanar_Params_crop.npz', *lasagne.layers.get_all_param_values(output))
np.savez('/home/xvt131/Functions/Adhish_copy/TP_param/Loss_values_Tri_crop.npz', loss, train_acc, valid_loss, valid_acc )
