...
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/window_thresh.npz', *lasagne.layers.get_all_param_values(output))
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/window_thresh_perf.npz', loss, train_acc, valid_loss, valid_acc )
