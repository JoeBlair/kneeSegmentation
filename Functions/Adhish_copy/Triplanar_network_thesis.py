...
l_conv_1 = lasagne.layers.dnn.Conv2DDNNLayer(input, 50, (3,3), nonlinearity=lasagne.nonlinearities.rectify)

l_maxpool_1 = lasagne.layers.dnn.Pool2DDNNLayer(l_conv_1, (2,2))

l_conv_2 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_1, 50,(5,5), nonlinearity=lasagne.nonlinearities.rectify)

l_conv_3 = lasagne.layers.dnn.Conv2DDNNLayer(l_conv_2, 50, (9,9), nonlinearity=lasagne.nonlinearities.rectify)

#l_maxpool_2 = lasagne.layers.dnn.MaxPool3DDNNLayer(l_conv_2, (2,2,2))

l_hidden1 = lasagne.layers.DenseLayer(l_conv_3, num_units=1000, nonlinearity=lasagne.nonlinearities.rectify,W=lasagne.init.HeNormal(gain='relu'))

# Conv Net patch si
input2 = lasagne.layers.InputLayer((None, 1, PS, PS), input_var=input2_var)

l_conv_11 = lasagne.layers.dnn.Conv2DDNNLayer(input2, 50, (3,3), nonlinearity=lasagne.nonlinearities.rectify)

l_maxpool_11 = lasagne.layers.dnn.Pool2DDNNLayer(l_conv_11, (2,2))

l_conv_22 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_11, 50, (5,5), nonlinearity=lasagne.nonlinearities.rectify)
l_conv_33 = lasagne.layers.dnn.Conv2DDNNLayer(l_conv_22, 50, (9,9), nonlinearity=lasagne.nonlinearities.rectify)


l_hidden2 = lasagne.layers.DenseLayer(l_conv_33, num_units=1000,nonlinearity=lasagne.nonlinearities.rectify,W=lasagne.init.HeNormal(gain='relu'))

# 3rd plane
input3 = lasagne.layers.InputLayer((None, 1, PS, PS), input_var=input3_var)

l_conv_111 = lasagne.layers.dnn.Conv2DDNNLayer(input3, 50, (3,3), nonlinearity=lasagne.nonlinearities.rectify)

l_maxpool_111= lasagne.layers.dnn.Pool2DDNNLayer(l_conv_111, (2,2))

l_conv_222 = lasagne.layers.dnn.Conv2DDNNLayer(l_maxpool_111, 50,(5,5), nonlinearity=lasagne.nonlinearities.rectify)
l_conv_333 = lasagne.layers.dnn.Conv2DDNNLayer(l_conv_222, 50, (9,9), nonlinearity=lasagne.nonlinearities.rectify)

l_hidden3 = lasagne.layers.DenseLayer(l_conv_333, num_units=1000,nonlinearity=lasagne.nonlinearities.rectify,W=lasagne.init.HeNormal(gain='relu'))
...
updates = lasagne.updates.adadelta(all_grads, all_params, learning_rate=0.001)
...
Train = DP.get_paths("/home/xvt131/Biomediq/Data/kneeData/Training-Rand")
