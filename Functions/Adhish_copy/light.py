...
updates = lasagne.updates.adadelta(all_grads, all_params, learning_rate=0.0001, rho=0.95, epsilon=1e-06)
...
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/light.npz', *lasagne.layers.get_all_param_values(output))
np.savez('/home/xvt131/Functions/Adhish_copy/Exp101/light_loss.npz', loss, train_acc, valid_loss, valid_acc )
