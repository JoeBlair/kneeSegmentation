...
with np.load('/home/xvt131/Functions/Adhish_copy/Exp101/cheat.npz') as f:
...
for img in DP.get_paths("/home/xvt131/Functions/Adhish_copy/Testing-Rand"):
    ...
    io.savemat("/home/xvt131/Functions/Adhish_copy/smaller/%s" %(img[51:]), mdict= {"Seg":Segs,"Lab":Lab} )
